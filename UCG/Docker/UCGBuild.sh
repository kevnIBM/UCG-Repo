...
docker build -f latest/Dockerfile-Data-Volume-Mapped -t dennisnotojr/node-red-docker-node8-nr-17-data-mapped:version-4 .
...
docker push dennisnotojr/node-red-docker-node8-nr-17-data-mapped:version-4
